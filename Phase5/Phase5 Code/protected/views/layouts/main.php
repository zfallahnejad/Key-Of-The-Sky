...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $baseUrl;?>/js/jalaliCalendar/assets/skins/aqua/theme.css">
	<script src="<?php echo $baseUrl;?>/js/jalaliCalendar/assets/js/jalali.js"></script>
	<script src="<?php echo $baseUrl;?>/js/jalaliCalendar/assets/js/calendar.js"></script>
	<script src="<?php echo $baseUrl;?>/js/jalaliCalendar/assets/js/calendar-setup.js"></script>
	<script src="<?php echo $baseUrl;?>/js/jalaliCalendar/assets/js/lang/calendar-fa.js"></script>
